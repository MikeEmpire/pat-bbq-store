...
export default function About(): JSX.Element {
  return (
    <section
      className={`${styles.about_us__section} px-4 md:px-16 lg:px-56 py-12`}
      id="about"
    >
      {/* Main Header */}
      <motion.header
      ...
      >
        <p className="mb-6">
          At Ptrain&apos;s California BBQ, we&apos;re passionate about bringing
          authentic, mouthwatering BBQ catering to every corner of Southern
          California. From Rancho Cucamonga to Los Angeles County, Orange
          County, and the Inland Empire, our team proudly serves up smoky
          perfection for every occasion — from corporate events to private
      ...
      >
        ...
        <p className="text-lg md:text-xl leading-relaxed mb-4">
          Whether you&apos;re hosting a company picnic, employee appreciation
          lunch, wedding reception, or a large festival, we offer affordable BBQ
        ...
        <p className="text-lg md:text-xl leading-relaxed">
          ...
          Ptrain&apos;s California BBQ one of the most trusted names in
          corporate catering Southern California.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-lg md:text-xl leading-relaxed mt-6">
          ...
          <strong>BBQ catering near me</strong>,
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
          ...
          <div className="w-full md:w-7/12">
            <p className="text-lg md:text-2xl leading-relaxed mb-4">
              ...
              represent. What started as Pat &quot;Ptrain&quot; Patterson&apos;s
              dream of serving real wood smoked pizzas, his original bbq sauces
              and the perfect Tri Tip sandwich has turned into so much more.
            </p>
